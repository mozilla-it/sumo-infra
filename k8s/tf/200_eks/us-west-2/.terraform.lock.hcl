...
provider "registry.terraform.io/hashicorp/aws" {
  version     = "4.26.0"
  constraints = ">= 2.23.0, > 3.0.0, >= 3.56.0, >= 4.26.0, < 4.27.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/kubernetes" {
  version     = "2.12.1"
  constraints = ">= 1.11.1, ~> 2.0, >= 2.12.1, < 2.13.0"
  hashes = [
